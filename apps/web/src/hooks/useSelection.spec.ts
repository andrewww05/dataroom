...
describe('useSelection', () => {
  const items: FsNode[] = [
    { id: '1', name: 'File 1', type: 'FILE', parentId: null, sizeBytes: 10, mimeType: 'text/plain', createdAt: '', updatedAt: '' },
    { id: '2', name: 'File 2', type: 'FILE', parentId: null, sizeBytes: 20, mimeType: 'text/plain', createdAt: '', updatedAt: '' },
    { id: '3', name: 'File 3', type: 'FILE', parentId: null, sizeBytes: 30, mimeType: 'text/plain', createdAt: '', updatedAt: '' },
    { id: '4', name: 'File 4', type: 'FILE', parentId: null, sizeBytes: 40, mimeType: 'text/plain', createdAt: '', updatedAt: '' },
    { id: '5', name: 'File 5', type: 'FILE', parentId: null, sizeBytes: 50, mimeType: 'text/plain', createdAt: '', updatedAt: '' },
  ];
